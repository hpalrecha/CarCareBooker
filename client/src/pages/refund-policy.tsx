    ...
    <div className="p91-brand min-h-screen bg-deep-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-invert max-w-none">
          <h1 className="text-2xl sm:text-4xl font-bold gradient-text mb-8" data-testid="text-refund-title">
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-medium-gray p-4 rounded-lg">
                  <h3 className="text-white font-semibold">Exterior Detailing (₹3,500)</h3>
