...
export default function PpfCeramicLanding() {
  ...
  const testimonials = [
    ...
    { name: "Vikram J.", vehicle: "Audi Q5", rating: 5, comment: "Bangalore's best detailing studio! The P91 PPF is incredible value for money." },
    { name: "Sneha R.", vehicle: "Honda City", rating: 5, comment: "My car looks brand new after ceramic coating. Highly recommend P91!" },
    { name: "Karthik N.", vehicle: "KTM Duke 390", rating: 5, comment: "PPF on my Duke is perfect. No more worrying about stone chips on highways." },
    { name: "Anjali T.", vehicle: "Hyundai Creta", rating: 5, comment: "Amazing work! The team is very professional and the results are stunning." },
    { name: "Ravi P.", vehicle: "Maruti Swift", rating: 5, comment: "Best investment for my car. The ceramic coating makes washing so easy now." },
    { name: "Meera S.", vehicle: "Tata Nexon", rating: 5, comment: "Excellent service! They took great care of my car. Highly satisfied." },
    { name: "Suresh K.", vehicle: "Toyota Fortuner", rating: 5, comment: "Premium experience at reasonable prices. Will definitely come back!" },
    { name: "Divya M.", vehicle: "Kawasaki Ninja", rating: 5, comment: "PPF installation was flawless. My bike looks absolutely stunning now." },
    { name: "Arjun B.", vehicle: "Skoda Octavia", rating: 5, comment: "The P91 team is amazing. Very knowledgeable and detail-oriented." },
    { name: "Lakshmi R.", vehicle: "MG Hector", rating: 5, comment: "Great value for ceramic coating. My car shines like never before!" },
    { name: "Nikhil G.", vehicle: "Jeep Compass", rating: 5, comment: "Fantastic work on my Compass. The PPF quality is top-notch." },
    { name: "Pooja D.", vehicle: "Honda Activa", rating: 5, comment: "Even for my scooter, they provided excellent ceramic coating service." },
    { name: "Venkat R.", vehicle: "Ford Endeavour", rating: 5, comment: "Large vehicle, no problem! P91 handled it like pros. Highly recommend!" },
    { name: "Shalini K.", vehicle: "Volkswagen Polo", rating: 5, comment: "Best detailing studio in Bangalore! Worth every penny spent." },
    { name: "Mohan V.", vehicle: "Yamaha R15", rating: 5, comment: "PPF on my R15 looks amazing. Great protection for highway rides." },
    { name: "Rekha N.", vehicle: "Kia Seltos", rating: 5, comment: "Exceptional service and attention to detail. My Seltos looks showroom fresh!" },
    { name: "Prasad T.", vehicle: "Mahindra XUV700", rating: 5, comment: "Went for PPF + ceramic combo. My XUV700 looks absolutely stunning!" },
    { name: "Kavitha S.", vehicle: "Maruti Baleno", rating: 5, comment: "Professional team, great results. Will recommend to all my friends." },
    { name: "Rajesh H.", vehicle: "BMW X1", rating: 5, comment: "P91 is the best! No questions asked warranty gave me total peace of mind." },
  ];
