      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-8 text-gray-300 leading-relaxed">
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">1. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">2. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">3. Information Sharing and Disclosure</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">4. Data Security</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">5. Data Retention</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">6. Your Rights</h2>
            ...
            <section>
              ...
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">7. Cookies and Tracking</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">8. Updates to Privacy Policy</h2>
              <p>We may update this privacy policy periodically. Changes will be posted on our website with an updated effective date.</p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-[var(--neon-green)] mb-4">9. Contact Us</h2>
